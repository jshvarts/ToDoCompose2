...
import com.jshvarts.todocompose.component.DisplayAlertDialog
...
import com.jshvarts.todocompose.ui.theme.TOP_APP_BAR_HEIGHT
...
import com.jshvarts.todocompose.util.TrailingIconState
...
fun SortAction(
    ...
    IconButton(onClick = { expanded = true }) {
        ...
        DropdownMenu(
            ...
            Priority.values().filter { priority ->
                priority == Priority.LOW || priority == Priority.HIGH || priority == Priority.NONE
            }.forEach { priority ->
